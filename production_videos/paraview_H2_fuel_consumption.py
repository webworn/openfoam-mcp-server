...
# Field: H2, Type: fuel_consumption
...
reader.CellArrays = ['H2', 'p', 'T', 'U', 'H2', 'O2', 'rho']
...
title = pv.Text()
title.Text = '2D Rotating Detonation Engine - H2 Field\nReal CFD Simulation Results'
...
# Save animation
output_path = "production_videos/rde_H2_fuel_consumption.avi"

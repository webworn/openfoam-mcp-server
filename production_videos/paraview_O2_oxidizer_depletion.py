...
# Field: O2, Type: oxidizer_depletion
...
reader.CellArrays = ['O2', 'p', 'T', 'U', 'H2', 'O2', 'rho']
...
title = pv.Text()
title.Text = '2D Rotating Detonation Engine - O2 Field\nReal CFD Simulation Results'
...
# Save animation
output_path = "production_videos/rde_O2_oxidizer_depletion.avi"

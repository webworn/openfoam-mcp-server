...
# Field: temperature, Type: detonation_wave
...
reader.CellArrays = ['temperature', 'p', 'T', 'U', 'H2', 'O2', 'rho']
...
title = pv.Text()
title.Text = '2D Rotating Detonation Engine - TEMPERATURE Field\nReal CFD Simulation Results'
...
# Save animation
output_path = "production_videos/rde_temperature_detonation_wave.avi"

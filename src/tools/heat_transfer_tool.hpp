...
public:
    ...
    { 
        return "Analyze conjugate heat transfer using OpenFOAM chtMultiRegionFoam solver. "
               "Supports electronics cooling, heat exchangers, building thermal analysis, and engine cooling. "
               "Calculates thermal resistance, heat transfer coefficients, temperature distributions, and "
